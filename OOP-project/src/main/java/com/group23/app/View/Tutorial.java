...
public class Tutorial extends JFrame implements KeyListener{
    ...
    JLabel text = new JLabel("The goal of the game is to avoid being hit by the laserbeams. You move by using.... The laserbeam will come in from directions around the screen in a rate that is increasing with the longer you play.");
