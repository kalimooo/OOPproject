...
public class TitleField extends JPanel{
    ...
    private TitleField() {
        ...
        promptS = new JLabel("Press Y to to enter the Settings!");
        ...
        this.bgImg = GameWindow.loadScaledImage("src/main/java/com/group23/app/View/Images/Images/AlternativeBG2.jpg", fieldWidth, fieldWidth).getImage();
